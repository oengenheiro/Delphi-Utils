...
function IsValidDate(const Value: string; out ADate: TDate): Boolean;
function IsValidTime(const Value: string; out ATime: TTime): Boolean;
...
type
  ...
  public
    ...
    class function IsValidDate(const Value: string; out ADate: TDate): Boolean;
    class function IsValidTime(const Value: string; out ATime: TTime): Boolean;
...
class destructor TDateUtils.Destroy;
begin
  RestoreOriginalDate;
end;

class function TDateUtils.IsValidDate(const Value: string; out ADate: TDate): Boolean;
var
  LDateTime: TDateTime;
begin
...
class function TDateUtils.IsValidTime(const Value: string; out ATime: TTime): Boolean;
var
  LDateTime: TDateTime;
begin
